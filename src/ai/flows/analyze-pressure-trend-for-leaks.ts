// This is an autogenerated file from running `npm run genkit:sync`
'use server';
/**
...
You will be provided with a segment of pressure sensor data, an analysis model (linear or non-linear), and a sensitivity threshold (R-squared value).
